...
class PoliticiansList extends Component {
    ...
    componentDidMount = async () => {
        ...
        await api.getAllPoliticians().then(politicians => {
            this.setState({
                ...
                politiciansJSON: PoliticiansData,
                isLoading: false,
            })
        })
    }
    ...
    render() {
        const { politicians,politiciansJSON, isLoading } = this.state
        console.log('TCL: PoliticiansList -> render -> politicians',politiciansJSON politicians)
        ...
        return (
            <Wrapper>
                {showTable && (
                    <ReactTable
                        data={politicians+politiciansJSON}
                        columns={columns}
                        loading={isLoading}
                        defaultPageSize={50}
