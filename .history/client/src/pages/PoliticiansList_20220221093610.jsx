...
class PoliticiansList extends Component {
    ...
    componentDidMount = async () => {
        ...
        const content = fs.readFile('politicians.json','utf8');
    ...
    render() {
        const { politicians,content, isLoading } = this.state
        console.log('TCL: PoliticiansList -> render -> politicians',content, politicians)
