...
class PoliticiansUpdate extends Component {
    ...
    handleIncludePolitician = async () => {
        const { nombre, apellidos, partido } = this.state
        const arrayPartido = partido.split('/')
        const payload = { nombre, apellidos, partido, salarioAnual: arrayPartido}
    ...
    componentDidMount = async () => {
        ...
        this.setState({
            ...
            partido: politician.data.data.partido.join('/'),
        })
    }
