...
El archivo csv (politicians.csv) adjunto en esta carpeta está editado para que se pueda importar en MONGO y clasifique los campos que requiere la app, por defecto de la plantilla, en los datos que se importen del csv se van a ver el nombre y apellido en el mismo campo "nombre", ya que no vienen separados en campos diferentes.
